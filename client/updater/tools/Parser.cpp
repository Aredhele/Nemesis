...
#include "../include/tools/Parser.hpp"

/**
 * \brief Constructor.
 */
Parser::Parser() {
    m_configurationFilePath = "../config/config.conf";
    m_ptr_configuration = new Configuration();
}
 ...
 */
Parser::Parser(std::string configurationFilePath) {
...
Configuration * Parser::parse() {
    ...
    try {
        ...
        //m_ptr_displayer->displayFailure("Opening configuration file");
        std::cerr << e.what() << std::endl;
        return nullptr;
    }

    //m_ptr_displayer->displayInfo("Configuration file opened");
    ...
    //m_ptr_displayer->displayInfo("Configuration fully loaded");
    delete(parameter);
    parameter = nullptr;
    file.close();
...
Vector2Str * Parser::getParameters(std::string line) {
    ...
    try {
        ...
        //m_ptr_displayer->displayFailure("Error while parsing configuration file");
        std::cerr << e.what() << std::endl;
        return nullptr;
    }
