...
void GameManager::initCharacters(){
    ...
    m_characterList[0]->setCaracteristics(50,3000,30);
    ...
    m_characterList[1]->setCaracteristics(500,4000,35);
    ...
    m_characterList[2]->setCaracteristics(250,7000,40);
    ...
    m_characterList[3]->setCaracteristics(100,15000,50);
